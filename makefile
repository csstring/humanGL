...
SOURCES = $(wildcard $(SRC_DIR)/*.cpp $(SRC_DIR)/Body/*.cpp $(SRC_DIR)/Math/*.cpp $(SRC_DIR)/AnimationBlend/*.cpp)
# 오브젝트 파일 리스트
OBJECTS = $(patsubst $(SRC_DIR)/%.cpp,$(OBJ_DIR)/%.o,$(patsubst $(SRC_DIR)/Math/%.cpp,$(OBJ_DIR)/%.o,$(patsubst $(SRC_DIR)/Body/%.cpp,$(OBJ_DIR)/%.o,$(patsubst $(SRC_DIR)/AnimationBlend/%.cpp,$(OBJ_DIR)/%.o,$(SOURCES)))))
